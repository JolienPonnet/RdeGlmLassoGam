...
##' Adding a penalized truncated power basis class and methods as favoured by Ruppert, Wand and Carroll (2003)
##' Semiparametric regression CUP. (No advantage to actually using this, since mgcv can happily handle non-identity penalties.)
##' @param object a smooth specification object, usually generated by a term s(...,bs="ad",...)
##' @param data a list containing just the data (including any by variable) required by this term,
##' with names corresponding to object$term (and object$by). The by variable
##' is the last element.
##' @param knots a list containing any knots supplied for basis setup - in same order and with
...
##' for gam fitting, create square of S matrix
##' @param S S matrix
mat.sqrt<- function(S){
