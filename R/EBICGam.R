##' This function estimates the EBIC value for the dispersion parameters. This can be used for the tuning of the penalty parameter in the sparse dispersion model of the RDE estimator.
