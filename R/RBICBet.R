##' This function estimates the RBIC value for the mean parameters. This can be used for the tuning of the smoothing parameter in the  mean model of the RDE estimator in the GAM setting.
