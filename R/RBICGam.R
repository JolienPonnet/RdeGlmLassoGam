##' This function estimates the RBIC value for the mean parameters. This can be used for the tuning of the smoothing parameter in the dispersion model of the RDE estimator in the GAM setting.
...
##' @param sp1 a vector of smoothing parameter for the mean model in case muEstim equals "gam". If only one value is specified, it will be used for all smoothing parameters in this model.
##' @param smooth.basis1 the specification of basis for the mean model in case muEstim equals "gam". Four choices are available: "tp" = thin plate regression spline, "cr" = cubic regression spline, "ps" = P-splines, "tr" = truncated power spline.
